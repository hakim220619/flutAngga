...
import 'package:flutmsekolah/login/view/login.dart';

import 'package:shared_preferences/shared_preferences.dart';
import 'package:flutmsekolah/home/HomePage.dart';
import 'package:flutter_dotenv/flutter_dotenv.dart';

class HttpService {
  static final _client =http.Client() ;

  static final _loginUrl = Uri.parse('${dotenv.env['url']}/loginApi');
  ...
  static login(email, password, context) async {
    ...
    if (response.statusCode == 200) {
      ...
      await pref.setString("full_name", Users['userData']['full_name'].toString());
      await pref.setString("role", Users['userData']['role'].toString());
      await pref.setString("phone", Users['userData']['phone'].toString());
